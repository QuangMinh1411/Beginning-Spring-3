...
public class VideoRepositoryHsqlTest {
    ...
    void findByNameShouldRetrieveOneEntry(){
        ...
        assertThat(videos).extracting(VideoEntity::getName).containsExactlyInAnyOrder("Need HELP with your SPRING BOOT 3 App?");
    }
    ...
    void findByNameOrDescriptionShouldFindTwo() {
        ...
        assertThat(videos).extracting(VideoEntity::getDescription).contains("As a pro developer, never ever EVER do this to your code.", "Discover ways to not only debug your code");
    }
}
